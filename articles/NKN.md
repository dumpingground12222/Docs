# NKN
*Updated at **27.03.2018** by **ResidentTGT***
...
Всего токенов 1 млрд, 35% будет продано, 18% зарезервировано для разработчиков и советников на 3 года, будут разлочиваться каждый год по трети, 17% зарезервировано для "Foundation", 30% для майнеров (по их расчетам намайнят все за 25 лет) <br>
Roadmap:
