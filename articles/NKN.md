...
### Недостатки
- слишком амбициозные цели, для реализации таких вещей требуется много высококлассных специалистов, не только управленцев и архитекторов, которые указаны в команде, но и обычных разработчиков, информации о которых нет
