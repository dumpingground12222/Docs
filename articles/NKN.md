...
Является **сооснователем Onechain**, **участник разработки сетевой подсистемы ядра Линукс**, возглавлял офис Onechain в Пекине и разрабатывал блокчейн-плафторму DNA, учился в Оксфорде и имеет большой опыт в криптографии. Более 10 лет работал в НИОКР Нокиа, Куалкомм, специализируясь на проектировании архитектуры распределнных сетей и сетчатых сетевых протоколов.<br>
Onchain - одна из ведущих технологических компаний в области блокчейна в Китае. Являясь управляющим членом форума по развитию блокчейна MIIT, компания работает с правительством, чтобы установить стандарты блокчейна в Китае. Команда Onchain состоит из технических и бизнес-экспертов, в том числе некоторые из первых китайских блокчейн-разработчиков; эксперты технической архитектуры крупных финансовых учреждений; и CFA- и FRM-сертифицированные финансовые эксперты из крупных мировых банков.
...
- отдельный плюс основателю за то, что является сооснователем Onchain, компании, которую можно назвать флагманом блокчейн-индустрии в Китае и обладающей большими финансовыми возможностями
...
## Update 16.03
Мне скинули [обзор](https://cryptobriefing.com/nkn-ico-review-nnc-token-analysis/#1507666906438-36064db9-bed3), который, в основном, переведенная копипаста wp проекта, но в нем хорошо описаны опасения по поводу него (некоторые поднятые темы до этого я включил в список вопросов от нашего сообщества представителю NKN) и сделан очень лаконичный вывод, с которым я на 100% согласен и перевод которого представлен ниже.
> NKN преподносит проект, который на законных основаниях можно назвать революционным. Но как однажды сказали Леннон с Маккартни: "Вы говорите, что у вас есть реальное решение / Ну, вы знаете / Мы все будем рады увидеть план."
Для проекта такого масштаба на ранних этапах разработки у нас есть концепция продукта и команда в качестве наших основных показателей относительно того, делать ставку на этот проект или нет. Тяжело было бы найти команду, более подходящую для задач создания и запуска нового вида сети.
